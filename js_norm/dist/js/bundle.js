...
function tabs() {
  ...
  var showTabContent = function showTabContent(a) {
...
function timer() {
  var deadline = '2019-03-10';

  var getTimeRemain = function getTimeRemain(endTime) {
    var zeroPlus = function zeroPlus(date) {
